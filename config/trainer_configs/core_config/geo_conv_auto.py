...
def create_master_config(default_dict):
	...
	data_config_module = importlib.import_module("config.trainer_configs.data_config." + default_dict["cfg"])
	save_config_module = importlib.import_module("config.trainer_configs.save_config." + default_dict["cfg"])
	model_config_module = importlib.import_module("config.trainer_configs.model_config." + default_dict["cfg"])
	reload_config_module = importlib.import_module("config.trainer_configs.reload_config." + default_dict["cfg"])
